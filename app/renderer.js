...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getMCPServers: () => ipcRenderer.invoke('getMCPServers'),
  saveMCPServer: (server) => ipcRenderer.invoke('saveMCPServer', server),
  deleteMCPServer: (id) => ipcRenderer.invoke('deleteMCPServer', id),
  startMCPServer: (id) => ipcRenderer.invoke('startMCPServer', id),
  stopMCPServer: (id) => ipcRenderer.invoke('stopMCPServer', id),
